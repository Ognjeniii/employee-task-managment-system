...
<head>
    ...
    <title>Kreiraj tip korisnika</title>
    <style>
...
<body>
    ...
    <h1>Kreiraj novi tip korisnika</h1>
        <div class="form-container">
            <form action="../logika_admin/kreiranje_tipa.php" method="post">
                <label for="">Unesite naziv tipa:</label>
                <input type="text" name="naziv_tipa" placeholder="Naziv tipa:" required>
                <input type="submit" value="KREIRAJ TIP" class="dugme">
            </form>
        </div>
</body>
</html>