...
<body>
    <h1>Promeni komentar</h1>
    <div class="form-container">
        <form action="../logika_admin/menjanje_komentara.php" method="post">
            <label for="">Oznacite komentar koji zelite da promenite:</label>
            <select name="id_komentara">
                <?php foreach ($sviKomentari as $komentar): ?>
                            <option value="<?= $komentar->id ?>"><?= $komentar->id ?></option>
                <?php endforeach ?>
            </select>
            <label for="">Unesite novi sadrzaj komentara:</label>
            <textarea name="sadrzaj_komentara" cols="30" rows="5"></textarea>
            ...
            <input type="submit" value="PROMENI KOMENTAR" class="dugme">
        </form>
    </div>
</body>
</html>